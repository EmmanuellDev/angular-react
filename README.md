...
Built using [Angular JS](https://docs.angularjs.org/guide/services), this interface and the layout were made from scratch.
...
```
git clone https://github.com/EmmanuellDev/angular-react.git
npm install
```
